        ...
        <div class="row">
            ...
            <!-- <input type="button" value="Go!" onclick="refreshApp()" id="btnGo"><br><br> -->
               ...
               <div class="row" style="margin-left: 0px; padding-bottom:15px">
                   <div class="col-md-10" style="text-align: center"><h2>Semaine du 7 novembre 2016 au 10 decembre 2017</h2></div>
...
<script>
    ...
    function hideShowEntreprises() {
        ...
        x.innerHTML = "@e.nom_Entreprise <input id=\"@e.id\" type=\"checkbox\" onchange=\"ajusterEmplacements()\" class=\"chkEntreprise chkSubContent\">" ;
            entreprises.appendChild(x);


        @code
                System.Diagnostics.Debug.WriteLine(e.nom_Entreprise)
            Next
        End Code
    ...
    function hideShowEmplacements() {
        ...
        @code
            ...
            x = document.createElement("div");
            x.style = "margin-right: 30px; padding-bottom: 5px";
            x.innerHTML = "@e.nom_Emplacement <input type=\"checkbox\" class=\"@e.entreprise.id chkEmplacement chkSubContent\">";
    ...
    function hideShowEmployes() {
        ...
        @code
            ...
            x = document.createElement("div");
            x.style = "margin-right: 30px; padding-bottom: 5px";
            x.innerHTML = "@u.prenom @u.nom  <input type=\"checkbox\"  class=\"chkSubContent\">";
