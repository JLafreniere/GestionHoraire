...
let ws1 = new workshift("Jean", new Date(2016, 10, 4, 5, 0, 0), new Date(2016, 10, 4, 6, 45, 0));
//let ws2 = new workshift("Pierre", new Date(2016, 10, 5, 10, 00, 0), new Date(2016, 10, 4, 17, 15, 0));
